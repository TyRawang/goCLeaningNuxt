  ...
  data() {
    return {
      bannerPageMaterials: {
        ...
        pageTitle: 'OFFICES & RETAIL CLEANING',
        pageSubtitle: 'Commercial Janitorial Services',
        hasButton: true
      },
      ...
      sectionContentOne: {
        fullWidth: false,
        imageRight: true,
        imagePath: 'https://pictureperfectcleaning.ca/wp-content/uploads/2019/08/office-image1.jpg',
      ...
      sectionContentTwo: {
        fullWidth: false,
        imageRight: false,
        imagePath: 'https://pictureperfectcleaning.ca/wp-content/uploads/2019/08/office-image2.jpg',
