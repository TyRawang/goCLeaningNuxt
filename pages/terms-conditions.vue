<template>
  <div class="container">
    ...
    <p>We employ the use of cookies. By accessing Go Cleaning, you agreed to use cookies in agreement with the Go
      Cleaning's Privacy Policy.</p>
    ...
    <p>Unless otherwise stated, Go Cleaning and/or its licensors own the intellectual property rights for all material
      on Go Cleaning. All intellectual property rights are reserved. You may access this from Go Cleaning for your own
      personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Go Cleaning</li>
      <li>Sell, rent or sub-license material from Go Cleaning</li>
      <li>Reproduce, duplicate or copy material from Go Cleaning</li>
      <li>Redistribute content from Go Cleaning</li>
    </ul>

    <p>This Agreement shall begin on the date hereof.</p>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
      areas of the website. Go Cleaning does not filter, edit, publish or review Comments prior to their presence on the
      website. Comments do not reflect the views and opinions of Go Cleaning,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, Go Cleaning shall not be liable for the Comments or for any liability, damages or expenses caused
      and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

    <p>Go Cleaning reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant Go Cleaning a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
      ...
      with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Go Cleaning; and
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
      must inform us by sending an e-mail to Go Cleaning. Please include your name, your organization name, contact
    ...
    <p>No use of Go Cleaning's logo or other artwork will be allowed for linking absent a trademark license
      agreement.</p>
