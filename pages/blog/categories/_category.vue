<template>
  <section>
    <TheBlogBanner2 :categoriesType="true" :categoryName="categoryName" />
...
export default {
  components: { RequestCallBack, TheBlogBx2, TheBlogBanner2 },
  ...
  async asyncData({ $strapi, params }) {
    ...
    const posts = categories[0].articles;
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Read our blogs and learn more about cleaning and Go Cleaning. We will share all our secrets behind creating a safe and clean environment!"
        ...
        },
        {
          hid: "og:title",
          name: "og:title",
          content: "Learn more about cleaning by reading our blogs | Blog"
        },
        {
          hid: "og:description",
          name: "og:description",
        ...
        },
        {
          ...
          name: "og:image",
          content:
            "https://res.cloudinary.com/dmw96e6jq/image/upload/v1607687583/rawpixel-679094-unsplash_sfrxw0.jpg"
        }
      ]
    };
  }
