...
export default {
  ...
  data() {
    return {
      bannerPageMaterials: {
        bannerImage: 'https://pictureperfectcleaning.ca/wp-content/uploads/2019/08/ppc-hero-schools-image.jpg',
        pageTitle: 'SCHOOLS & DAYCARES CLEANING',
      ...
      sectionContentOne: {
        fullWidth: false,
        imageRight: true,
        imagePath: 'https://pictureperfectcleaning.ca/wp-content/uploads/2019/08/school-image1.jpg',
      ...
      sectionContentTwo: {
        fullWidth: false,
        imageRight: false,
        imagePath: 'https://pictureperfectcleaning.ca/wp-content/uploads/2019/08/school-image2.jpg',
