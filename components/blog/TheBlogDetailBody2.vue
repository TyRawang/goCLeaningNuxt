  ...
  <section class="container">
    <div class="body">
      <div>
        <h1>{{ article.title }}</h1>
        <figcaption>
          By {{ article.author ? article.author : "Go Cleaning" }}
        </figcaption>
        <img :src="article.image.formats.large.url" alt="" />
        <div
          ...
          <span>
            ...
            <span class="share-link"
              ><ShareNetwork
                ...
                :hashtags="article.tags"
              >
                <i class="fab fa-whatsapp fa-lg"></i> </ShareNetwork
            ></span>
          </span>
        </div>
        <div>
          <h3>Get In Touch</h3>
          <a
            >Phone: 1 (855) 213-0087 <br />
            or <br />
            (403) 768-4186</a
          >
          <a
            >Email:
            <a href="mailto:info@gocleaning.ca">info@gocleaning.ca</a></a
          >
