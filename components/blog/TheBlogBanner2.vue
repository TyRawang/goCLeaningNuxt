    ...
    <div id="banner" >
        <div class="banner-bg">
            <div class="container">
                ...
                <div class="banner-form commercial">
                    <!-- <div class="meter orange nostripes">
                        <span style="width: 33.3%"></span>
                    </div> -->
                    <h1>Read Our Cleaning Blog</h1>
                    <h5>Cleaning Tips &amp; News<span></span></h5>
                </div>
            </div>
        </div>
    </div>
...
<style scoped>
    ...
    width: 100%;
    height: auto;
    background: url('~assets/images/bg/rawpixel-679094-unsplash.jpg') no-repeat center center/cover;
